...
analyize the sentiment of these companies in real time and then display that
...
android device that runs Android Lolipop or greater. This gives the user a lot
of flexiblity. It is really easy for anyone to install the app to their phone
and instintly get real time sentiment analysis. When the phone starts up it
...
caluclates the percent positive and uses that to update its GUI. For the gui we
