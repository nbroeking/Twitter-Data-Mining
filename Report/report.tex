...
Once we has the sentiment for each tweet we ran multiple tests to determine the correlation. TODO ANNAS STUFF 
...
After these two steps we also filtered out any stop words. Stop words are a list of words
...
and provides similar services to their customers. Mr. Wood told us that a 65% accuracy
...
but still wasn't as good as we wanted. We realized the problem was most likley
with the slowness of our code. We then spend the next week attempting to optim
